    ...
    <div>
      <footer class="site-footer">
                  ...
                  <div class="site-footer__bottom">
                      <div class="container">
                          <p class="site-footer__copy">&copy; Copyright 2020 by <a href="http://curtinatech.com" target="_blank">curtinatech.com</a></p>
                          <div class="site-footer__social">
                              <a href="#" data-target="html" class="scroll-to-target site-footer__scroll-top"><i class="kipso-icon-top-arrow"></i></a>
                              <a href="https://www.facebook.com/curtinastudy"><i class="fab fa-facebook-square"></i></a>
                              <a href="https://www.instagram.com/curtinastudyvisa/?hl=en"><i class="fab fa-instagram"></i></a>
                              <a href="https://wa.me/919215900374?text="><i class="fab fa-whatsapp text-success"></i></a>
